...
```
![crystalfire - Студент 1-го курса бакалавриата. Вайб-кодер :)](assets/profile-card.svg)
...
## 📁 Структура проекта
```
gitverse-custom-card-site/
├── public/ # Основные файлы сайта
│ ├── index.html # Главная страница
│ └── src/ # Исходный код
│ ├── script.js # Логика генератора карточек
│ └── style.css # Стили интерфейса
├── .github/workflows/ # Автоматизация CI/CD
│ └── course-validator.yml # Пайплайн проверок
